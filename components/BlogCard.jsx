...
const BlogCard = ({ post, handleEdit, handleDelete, handleTagClick }) => {
  ...
  return (
    <div className='flex-1 break-inside-avoid rounded-lg border border-gray-300 bg-white/20 bg-clip-padding p-6 pb-4 backdrop-blur-lg backdrop-filter xl:w-[25vw] md:w-[40vw] sm:w-[40vw] w-[80vw] h-fit'>
